// @ts-nocheck
/** onesignal CLI — migrated from tools/clis/onesignal.js */
let _dryRun = false;
...
export async function run(args) {
  ...
  if (!REST_API_KEY) throw new Error('ONESIGNAL_REST_API_KEY environment variable required');
  if (!APP_ID) throw new Error('ONESIGNAL_APP_ID environment variable required');
