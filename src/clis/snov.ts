// @ts-nocheck
/** snov CLI — migrated from tools/clis/snov.js */
let _dryRun = false;
...
export async function run(args) {
  ...
  if (!CLIENT_ID) throw new Error('SNOV_CLIENT_ID environment variable required');
  if (!CLIENT_SECRET) throw new Error('SNOV_CLIENT_SECRET environment variable required');
