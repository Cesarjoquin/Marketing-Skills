// @ts-nocheck
/** plausible CLI — migrated from tools/clis/plausible.js */
let _dryRun = false;
...
export async function run(args) {
  ...
  if (!API_KEY) throw new Error('PLAUSIBLE_API_KEY environment variable required');
  if (!BASE_URL) throw new Error('PLAUSIBLE_BASE_URL environment variable required');
