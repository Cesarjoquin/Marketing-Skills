// @ts-nocheck
/** dataforseo CLI — migrated from tools/clis/dataforseo.js */
let _dryRun = false;
...
export async function run(args) {
  ...
  if (!LOGIN) throw new Error('DATAFORSEO_LOGIN environment variable required');
  if (!PASSWORD) throw new Error('DATAFORSEO_PASSWORD environment variable required');
