// @ts-nocheck
/** segment CLI — migrated from tools/clis/segment.js */
let _dryRun = false;
...
export async function run(args) {
  ...
  if (!WRITE_KEY) throw new Error('SEGMENT_WRITE_KEY environment variable required');
  if (!ACCESS_TOKEN) throw new Error('SEGMENT_ACCESS_TOKEN environment variable required');
