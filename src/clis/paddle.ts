// @ts-nocheck
/** paddle CLI — migrated from tools/clis/paddle.js */
let _dryRun = false;
...
export async function run(args) {
  ...
  if (!API_KEY) throw new Error('PADDLE_API_KEY environment variable required');
  if (!BASE_URL) throw new Error('PADDLE_SANDBOX environment variable required');
