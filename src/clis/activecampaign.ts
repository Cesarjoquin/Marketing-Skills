// @ts-nocheck
/** activecampaign CLI — migrated from tools/clis/activecampaign.js */
let _dryRun = false;
...
export async function run(args) {
  ...
  if (!API_KEY) throw new Error('ACTIVECAMPAIGN_API_KEY environment variable required');
  if (!API_URL) throw new Error('ACTIVECAMPAIGN_API_URL environment variable required');
