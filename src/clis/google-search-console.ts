// @ts-nocheck
/** google-search-console CLI — migrated from tools/clis/google-search-console.js */
let _dryRun = false;
...
export async function run(args) {
  ...
  if (!ACCESS_TOKEN) throw new Error('GSC_ACCESS_TOKEN environment variable required');
