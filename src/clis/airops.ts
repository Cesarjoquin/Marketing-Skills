// @ts-nocheck
/** airops CLI — migrated from tools/clis/airops.js */
let _dryRun = false;
...
export async function run(args) {
  ...
  if (!API_KEY) throw new Error('AIROPS_API_KEY environment variable required');
  if (!WORKSPACE_ID) throw new Error('AIROPS_WORKSPACE_ID environment variable required');
