// @ts-nocheck
/** trustpilot CLI — migrated from tools/clis/trustpilot.js */
let _dryRun = false;
...
export async function run(args) {
  ...
  if (!API_KEY) throw new Error('TRUSTPILOT_API_KEY environment variable required');
  if (!API_SECRET) throw new Error('TRUSTPILOT_API_SECRET environment variable required');
  if (!BUSINESS_UNIT_ID) throw new Error('TRUSTPILOT_BUSINESS_UNIT_ID environment variable required');
