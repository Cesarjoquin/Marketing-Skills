// @ts-nocheck
/** keywords-everywhere CLI — migrated from tools/clis/keywords-everywhere.js */
let _dryRun = false;
...
export async function run(args) {
  ...
  if (!API_KEY) throw new Error('KEYWORDS_EVERYWHERE_API_KEY environment variable required');
