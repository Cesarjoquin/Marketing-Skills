// @ts-nocheck
/** meta-ads CLI — migrated from tools/clis/meta-ads.js */
let _dryRun = false;
...
export async function run(args) {
  ...
  if (!TOKEN) throw new Error('META_ACCESS_TOKEN environment variable required');
  if (!DEFAULT_ACCOUNT_ID) throw new Error('META_AD_ACCOUNT_ID environment variable required');
