// @ts-nocheck
/** kit CLI — migrated from tools/clis/kit.js */
let _dryRun = false;
...
export async function run(args) {
  ...
  if (!API_SECRET) throw new Error('KIT_API_SECRET environment variable required');
  if (!API_KEY) throw new Error('KIT_API_KEY environment variable required');
