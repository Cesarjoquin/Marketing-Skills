// @ts-nocheck
/** demio CLI — migrated from tools/clis/demio.js */
let _dryRun = false;
...
export async function run(args) {
  ...
  if (!API_KEY) throw new Error('DEMIO_API_KEY environment variable required');
  if (!API_SECRET) throw new Error('DEMIO_API_SECRET environment variable required');
