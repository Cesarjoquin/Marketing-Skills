// @ts-nocheck
/** zoominfo CLI — migrated from tools/clis/zoominfo.js */
let _dryRun = false;
...
export async function run(args) {
  ...
  if (!username) throw new Error('ZOOMINFO_USERNAME environment variable required');
  if (!password) throw new Error('ZOOMINFO_PRIVATE_KEY environment variable required');
