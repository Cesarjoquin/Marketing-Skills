// @ts-nocheck
/** partnerstack CLI — migrated from tools/clis/partnerstack.js */
let _dryRun = false;
...
export async function run(args) {
  ...
  if (!PUBLIC_KEY) throw new Error('PARTNERSTACK_PUBLIC_KEY environment variable required');
  if (!SECRET_KEY) throw new Error('PARTNERSTACK_SECRET_KEY environment variable required');
